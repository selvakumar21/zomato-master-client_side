    ...
    return (
        <>
            <div className='flex items-start gap-2'>
                ...
                <button  onClick={addFoodToCart} disabled={food?.isAddedToCart} className='flex items-center gap-2 text-zomato-400 bg-zomato-50 border border-zomato-400 px-2 py-1 rounded-lg'>
                                    {food?.isAddedToCart? ("Added"): (<><AiOutlinePlus/></>)}
                                </button>
                            </div>
                    </div>
                )}
