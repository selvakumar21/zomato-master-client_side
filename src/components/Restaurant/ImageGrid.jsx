        ...
        <>
            <div className='w-full h-60 md:hidden'>
                ...
                <div className='w-full h-96 md:flex gap-1'>
                    ...
                    <div className='w-1/4 h-full flex flex-col overflow-hidden gap-1 '>
                        <div className='w-full h-2/4 overflow-hidden rounded-lg'>
                        <img src={props.images.length && props.images[1].location} alt='restaurant' className='w-full h-full object-cover object-center rounded-lg transform transition duration-700 hover:scale-110'/>
                        </div>
                        <div className='w-full h-2/4 overflow-hidden rounded-lg'>
                        <img src={props.images.length && props.images[2].location} alt='restaurant' className='w-full h-full object-cover object-center rounded-lg transform transition duration-700 hover:scale-110'/>                
                        </div>
                    </div>
